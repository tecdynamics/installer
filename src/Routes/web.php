...
Route::group(['namespace' => 'tecdynamics\installer\Controllers','middleware' => ['web', 'install']], function() {
Route::get('error/{var}', [
    'uses' => 'WelcomeController@error'
 ]);
});

Route::group(['prefix' => 'install','as' => 'LaravelInstaller::','namespace' => 'tecdynamics\installer\Controllers','middleware' => ['web', 'install']], function() {
    Route::get('/', [
        'as' => 'welcome',
...
//    Route::get('environment/saveWizard', [
//        'as' => 'environmentSaveWizard',
//        'uses' => 'EnvironmentController@saveWizard'
//    ]);
...
Route::group(['prefix' => 'update','as' => 'LaravelUpdater::','namespace' => 'tecdynamics\installer\Controllers','middleware' => 'web'],function() {
